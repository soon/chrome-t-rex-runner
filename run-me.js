...
boxCompare = function(tRexBox, obstacleBox) {
  var crashed = false;
...
createAdjustedCollisionBox = function(box, adjustment) {
...
shouldJump = function(obstacle, tRex, distance) {
  var boxes = {
    DUCKING: [
